...
#                        of executable (1/0)?
MODEL                = MOTOR
MODULES              = MOTOR_EXTI.c MOTOR_TIM.c main.c stm32xxxx_it.c
MODULES_OBJ          = MOTOR_EXTI.obj MOTOR_TIM.obj main.obj stm32xxxx_it.obj 
MAKEFILE             = MOTOR.mk
...
# Additional includes
ADD_INCLUDES = \
 -ID:/Simulink_stm32f4/STM32F407VET6/MOTOR  -ID:/Simulink_stm32f4/STM32F407VET6/MOTOR/MOTOR_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IE:/MATLAB/STM32-MAT/STM32/addSrc/inc 
